...
public class CommentController {
    ...
    public CommentResponseDto commentCreate(@PathVariable Long id, @RequestBody CommentRequestDto commentRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        CommentResponseDto commentResponseDto = commentService.createComment(id, commentRequestDto, userDetailsImpl);
        return commentResponseDto;
    }

    @PutMapping("api/comment/{id}")
    public CommentResponseDto commentUpdate(@PathVariable Long id, @RequestBody CommentRequestDto commentRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        CommentResponseDto commentResponseDto = commentService.updateComment(id, commentRequestDto, userDetailsImpl);
        return commentResponseDto;
    }

    @DeleteMapping("api/comment/{id}")
    public Map commentDelete(@PathVariable Long id, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
